    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDCus,NameCus,PhoneCus,EmailCus,PassCus")] Customer customer)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Customer", "ADHome", new { area = "Admin" });
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDCus,NameCus,PhoneCus,EmailCus,PassCus,GenderCus")] Customer customer)
        {
            if (ModelState.IsValid)
            {
